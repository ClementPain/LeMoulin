  ...
  return (
    ...
    <Form.Row>
      <Form.Group as={Col} controlId="formGridName">
        ...
        <Form.Control 
          type="name" placeholder="Enter name"  value ={newshop.name}
    ...
    <Form.Group controlId="exampleForm.ControlTextarea1">
      ...
      <Form.Control 
        as="textarea" rows={3} value ={newshop.description}
      ...
      <Form.Control 
        placeholder="1234 Main St" value ={newshop.address}
  ...
  <Form.Group controlId="formGridAddress2">
    ...
    <Form.Row>
      <Form.Group as={Col} controlId="formGridCity">
        ...
        <Form.Control value ={newshop.city}
      ...
      <Form.Group as={Col} controlId="formGridZip">
        ...
        <Form.Control value ={newshop.zip_code}
    ...
    <Form.Group id="formGridCheckbox">
      <Form.Check 
        type="checkbox" label="Active" value ={newshop.is_active}
